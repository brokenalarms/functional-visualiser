...
var _componentsFunctionBlockFunctionBlockJsx = require('./components/functionBlock/functionBlock.jsx');

var _componentsFunctionBlockFunctionBlockJsx2 = _interopRequireDefault(_componentsFunctionBlockFunctionBlockJsx);
...
var App = (function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2['default'].createElement('div', null, _react2['default'].createElement('h1', null, 'react working!'), _react2['default'].createElement('div', { className: 'd3-test' }, 'element that d3 is attached to'));
        }
    }]);
...
(0, _componentsFunctionBlockFunctionBlockJsx2['default'])();

},{"./components/functionBlock/functionBlock.jsx":159,"react":157}],159:[function(require,module,exports){
'use strict';
...
var drawFunc = function drawFunc() {
   console.log('drawing');
   _d32['default'].selectAll('.d3-test').append('svg').attr('class', 'function-block').append('text').attr('x', 10).attr('y', 10).attr('dy', '.35em').text('d3 appended element inside react component - first attempt');
   console.log('drawn');
};

exports['default'] = drawFunc;
